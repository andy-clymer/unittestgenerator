    ...
    public class StringParameterCheckMethodGenerationStrategy : IGenerationStrategy<IMethodModel>
    {
        ...
        public IEnumerable<MethodDeclarationSyntax> Create(IMethodModel method, ClassModel model)
        {
            ...
            for (var i = 0; i < method.Parameters.Count; i++)
            {
                ...
                var methodName = string.Format(CultureInfo.InvariantCulture, _frameworkSet.TestNamingConventions.StringParameterValueCheckNaming, model.GetMethodUniqueName(method), method.Parameters[i].Name.ToPascalCase());
